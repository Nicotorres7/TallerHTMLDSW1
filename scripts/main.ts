...
const nameElement: HTMLElement | null = document.getElementById('player-name');
const imageElement: HTMLElement | null = document.getElementById('player-image');
const bioElement: HTMLElement | null = document.getElementById('player-bio');
const clubsElement: HTMLElement | null = document.getElementById('player-clubs');
const buttonElement: HTMLElement | null = document.getElementById('player-button');
let index: number = 0;
